...
namespace TrustPaymentsPayment\Models;
...
/**
 * @ORM\Table(name="trustpayments_payment_order_transaction_mapping",
 *      uniqueConstraints={
 ...
 *          query="SELECT m.orderEmailSent FROM TrustPaymentsPayment\Models\OrderTransactionMapping m WHERE m.orderId = :orderId"
 *      ),
 *      @ORM\NamedQuery(
 *          name="getOrderEmailData",
 *          query="SELECT m.orderEmailSent, m.orderEmailVariables FROM TrustPaymentsPayment\Models\OrderTransactionMapping m WHERE m.orderId = :orderId"
 *      ),
 *      @ORM\NamedQuery(
 *          name="updateOrderEmailSent",
 *          query="UPDATE TrustPaymentsPayment\Models\OrderTransactionMapping m SET m.orderEmailSent = true, m.orderEmailVariables = null WHERE m.orderId = :orderId"
 *      ),
 *      @ORM\NamedQuery(
 *          name="lock",
 *          query="UPDATE TrustPaymentsPayment\Models\OrderTransactionMapping m SET m.lockedAt = CURRENT_TIMESTAMP() WHERE m.orderId = :orderId"
 *      )
 * })
 */
