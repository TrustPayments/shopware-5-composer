...
class LabelDescriptorGroup extends AbstractProvider
{
    ...
    {
        parent::__construct($apiClient->getInstance(), $cache, 'trustpayments_payment_label_descriptor_groups');
    }
    ...
    {
        $labelDescriptorService= new \TrustPayments\Sdk\Service\LabelDescriptionGroupService($this->apiClient);
