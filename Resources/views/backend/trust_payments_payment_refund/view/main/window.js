...
//{block name="backend/trustpayments_payment_refund/view/main/window"}
//{namespace name=backend/trustpayments_payment/main}
Ext.define('Shopware.apps.TrustPaymentsPaymentRefund.view.main.Window', {

    extend: 'Enlight.app.Window',

    title: '{s name="refund/window/title"}Create Refund{/s}',

    alias: 'widget.trustpayments-payment-refund-main-window',
    ...
    createForm: function() {
        ...
        var form = Ext.create('Shopware.apps.TrustPaymentsPaymentRefund.view.main.Form', {
            region: 'center',
            record: me.record,
    ...
    createActionButtons: function() {
        ...
        return [{
            ...
            cls: 'secondary',
            action: 'trustpayments-payment-refund-main-window-cancel'
        }, {
            text: me.snippets.button.create,
            cls: 'primary',
            action: 'trustpayments-payment-refund-main-window-create'
        }];
    }
