...
//{block name="backend/trustpayments_payment_refund/view/main/form"}
//{namespace name=backend/trustpayments_payment/main}
Ext.define('Shopware.apps.TrustPaymentsPaymentRefund.view.main.Form', {
    
    extend: 'Ext.grid.Panel',
    
    alias: 'widget.trustpayments-payment-refund-main-form',
            ...
            },
            {
                ...
                renderer: function(value, meta, record){
                    ...
                    return {
                        ...
                        items: [{
                            xtype: 'displayfield',
                            cls: 'trustpayments-payment-refund-reduction-value',
                            initComponent: function(){
                                var me = this;
                                me.callParent(arguments);
