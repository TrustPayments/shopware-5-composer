...
Ext.define('Shopware.apps.TrustPaymentsPaymentRefund.controller.Main', {
    ...
    init: function() {
        ...
        me.control({
            ...
            'trustpayments-payment-refund-main-window button[action=trustpayments-payment-refund-main-window-create]': {
    ...
    createRefund: function(){
        ...
        Ext.Ajax.request({
            url: '{url controller="TrustPaymentsPaymentRefund" action="createRefund"}',
            params: params,
