...
Ext.define('Shopware.apps.Order.TrustPaymentsPayment.view.Window', {
    
    override: 'Shopware.apps.Order.view.detail.Window',
    
    alias: 'widget.trustpayments-payment-order-transaction-window',
    ...
    createTabPanel: function() {
        ...
        if (me.record.get('trustpayments_payment') == true) {
            me.transactionTab = Ext.create('Shopware.apps.Order.PluginTrustPaymentsPayment.view.window.TransactionTab');
