...
Ext.define('Shopware.apps.TrustPaymentsPaymentManualTasksWidget.view.Main', {

    extend: 'Shopware.apps.Index.view.widgets.Base',

    alias: 'widget.trustpayments-payment-manual-tasks',

    title: '{s name="manual_task/window/title"}Trust Payments Payment - Manual Tasks{/s}',
    ...
    load: function(callback){
        ...
        Ext.Ajax.request({
            url: '{url controller=TrustPaymentsPaymentManualTasksWidget action=info}',
            async: true,
