...
//{block name="backend/trustpayments_payment_transaction/model/line_item"}
Ext.define('Shopware.apps.TrustPaymentsPaymentTransaction.model.LineItem', {
    ...
    fields: [
        //{block name="backend/trustpayments_payment_transaction/model/line_item/fields"}{/block}
        { name: 'id', type: 'string' },
