...
//{block name="backend/trustpayments_payment_transaction/view/transaction/line_items/grid"}
//{namespace name=backend/trustpayments_payment/main}
Ext.define('Shopware.apps.TrustPaymentsPaymentTransaction.view.transaction.LineItems.Grid', {
    
    extend: 'Ext.grid.Panel',
    
    alias: 'widget.trustpayments-payment-transaction-line-items-grid',
