...
//{block name="backend/trustpayments_payment_transaction/view/transaction/refunds"}
//{namespace name=backend/trustpayments_payment/main}
Ext.define('Shopware.apps.TrustPaymentsPaymentTransaction.view.transaction.Refunds', {
    
    extend: 'Ext.panel.Panel',
    
    alias: 'widget.trustpayments-payment-transaction-refunds',
    ...
    createGrid: function() {
        ...
        var grid = Ext.create('Shopware.apps.TrustPaymentsPaymentTransaction.view.transaction.Refunds.Grid', {
            record: me.record,
    ...
    createDetail: function() {
        ...
        var detail = Ext.create('Shopware.apps.TrustPaymentsPaymentTransaction.view.transaction.Refunds.Details', {
            region: 'east',
            width: '50%',
