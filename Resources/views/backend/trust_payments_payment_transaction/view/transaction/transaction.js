...
//{block name="backend/trustpayments_payment_transaction/view/transaction/transaction"}
//{namespace name=backend/trustpayments_payment/main}
Ext.define('Shopware.apps.TrustPaymentsPaymentTransaction.view.transaction.Transaction', {

    extend: 'Ext.tab.Panel',

    alias: 'widget.trustpayments-payment-transaction-transaction',
    ...
    createItems: function(){
    	...
    	var infoTab = Ext.create('Shopware.apps.TrustPaymentsPaymentTransaction.view.transaction.Details', {
    	...
    	if (me.record.getLineItems().count() > 0) {
        	var lineItemTab = Ext.create('Shopware.apps.TrustPaymentsPaymentTransaction.view.transaction.LineItems', {
    	...
    	if (me.record.getRefunds().count() > 0 || me.record.get('canRefund')) {
            var refundTab = Ext.create('Shopware.apps.TrustPaymentsPaymentTransaction.view.transaction.Refunds', {
