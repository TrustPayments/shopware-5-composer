...
//{block name="backend/trustpayments_payment_transaction/view/transaction/refunds/details"}
//{namespace name=backend/trustpayments_payment/main}
Ext.define('Shopware.apps.TrustPaymentsPaymentTransaction.view.transaction.Refunds.Details', {
    
    extend: 'Ext.panel.Panel',
    
    alias: 'widget.trustpayments-payment-transaction-refunds-details',
    ...
    createLineItemPanel: function(){
        ...
        var panel = Ext.create('Shopware.apps.TrustPaymentsPaymentTransaction.view.transaction.LineItems.Grid', {
            name: 'trustpayments-payment-transaction-line-item-grid',
            record: me.record,
