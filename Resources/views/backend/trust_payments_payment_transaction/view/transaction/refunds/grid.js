...
//{block name="backend/trustpayments_payment_transaction/view/transaction/refunds/grid"}
//{namespace name=backend/trustpayments_payment/main}
Ext.define('Shopware.apps.TrustPaymentsPaymentTransaction.view.transaction.Refunds.Grid', {
    
    extend: 'Ext.grid.Panel',
    
    alias: 'widget.trustpayments-payment-transaction-refunds-grid',
    ...
    stateRenderer: function(value) {
        ...
        switch (value) {
        case 'SUCCESSFUL':
            return '<div class="sprite-tick trustpayments-payment-refund-column-icon"></div>';
        case 'FAILED':
            return '<div class="sprite-cross trustpayments-payment-refund-column-icon"></div>';
        case 'MANUAL_CHECK':
            return '<div class="sprite-exclamation trustpayments-payment-refund-column-icon"></div>';
        case 'PENDING':
            return '<div class="sprite-arrow-circle-double trustpayments-payment-refund-column-icon"></div>';
        }
    }
