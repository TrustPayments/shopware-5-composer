...
//{block name="backend/trustpayments_payment_transaction/view/transaction/details"}
//{namespace name=backend/trustpayments_payment/main}
Ext.define('Shopware.apps.TrustPaymentsPaymentTransaction.view.transaction.Details', {
    
    extend: 'Ext.panel.Panel',
    
    alias: 'widget.trustpayments-payment-transaction-details',
    ...
    snippets: {
        ...
        button: {
            ...
            transaction: '{s name=transaction/button/transaction_link}View in Trust Payments{/s}',
            customer: '{s name=transaction/button/customer_link}View in Trust Payments{/s}',
